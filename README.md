...
|---|---|
| [SOW Generator](https://sow.dnewport.dev) | React tool for building Statements of Work with a live parts catalog |
| [Network Scanner](https://github.com/dnewp/personal-projects/tree/main/network-scanner) | Subnet scanner with multi-vendor auto-auth (cameras, switches, firewalls) |
| [VMS Site Poller](https://github.com/dnewp/personal-projects/tree/main/vms-site-poller) | Cloud polling service for distributed camera site health monitoring |
| [Linux TS App](https://github.com/dnewp/personal-projects/tree/main/linux-ts-app) | Interactive Bash CLI for Linux server diagnostics |
